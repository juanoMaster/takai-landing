...
export default function Home() {
  ...
  useEffect(function() {
    const timer = setTimeout(function() { if (!promoShown) { setPromoOpen(true); setPromoShown(true) } }, 1800)
      ...
      <section id="precios" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "100px 24px", maxWidth: "1100px", margin: "0 auto", textAlign: "center" as const }}>
          ...
          <div style={{ position: "relative", background: "rgba(15,15,15,0.92)", border: "1px solid " + BORDER, borderRadius: "20px", padding: "48px", boxShadow: "0 0 40px rgba(201,168,76,0.06)" }}>
            ...
            <button onClick={function() { setModal(true) }} style={{ width: "100%", background: GOLD, color: "#0a0700", border: "none", borderRadius: "10px", padding: "18px", fontSize: "16px", fontWeight: 600, cursor: "pointer", fontFamily: SANS, letterSpacing: "0.3px", boxShadow: "0 8px 32px rgba(201,168,76,0.25)" }}>{"¡QUIERO MI DEMO AHORA!"}</button>
          </div>
        </div>
      </section>
