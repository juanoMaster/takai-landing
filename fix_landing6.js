...
// CSS filter to adapt blue-on-white logo for dark page:
// invert(1) turns white->black (invisible on dark bg via screen blend) and blue->orange/gold
const LOGO_FILTER = "invert(1) sepia(0.8) saturate(3) hue-rotate(5deg) brightness(1.15)"
...
function SectionBg({ src, opacity = 0.09 }: { src: string; opacity?: number }) {
  return (
    <img
      ...
      alt=""
      aria-hidden="true"
      style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: opacity, pointerEvents: "none", userSelect: "none" as const }}
    />
  )
}
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, transition: "background 0.3s", background: scrolled ? "rgba(7,7,7,0.95)" : "transparent", borderBottom: scrolled ? "1px solid " + BORDER : "1px solid transparent", backdropFilter: scrolled ? "blur(12px)" : "none" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <img src="/takai-logo.png" alt="Takai" style={{ height: "36px", width: "auto", objectFit: "contain", filter: LOGO_FILTER, mixBlendMode: "screen" }} />
              ...
              return (
                <div key={i} style={{ position: "relative", background: "rgba(15,15,15,0.92)", border: "1px solid " + BORDER, borderRadius: "16px", overflow: "hidden" }}>
                  ...
                  <div style={{ height: "200px", overflow: "hidden", position: "relative" }}>
                    <img src={step.img} alt={step.title} style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.65 }} />
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "40px", flexWrap: "wrap" as const, gap: "24px" }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
                <img src="/takai-logo.png" alt="Takai" style={{ height: "30px", width: "auto", objectFit: "contain", filter: LOGO_FILTER, mixBlendMode: "screen" }} />
